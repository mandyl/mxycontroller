...
type FakeAts struct {
	Fake *FakeMxycontrollerV1alpha1
	ns   string
}

var atsResource = schema.GroupVersionResource{Group: "mxycontroller.k8s.io", Version: "v1alpha1", Resource: "ats"}

var atsKind = schema.GroupVersionKind{Group: "mxycontroller.k8s.io", Version: "v1alpha1", Kind: "At"}
