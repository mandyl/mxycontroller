...
import (
	...
	mxycontrollerv1alpha1 "github.com/mandyl/mxycontroller/pkg/apis/mxycontroller/v1alpha1"
	versioned "github.com/mandyl/mxycontroller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/mandyl/mxycontroller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/mandyl/mxycontroller/pkg/generated/listers/mxycontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MxycontrollerV1alpha1().Ats(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MxycontrollerV1alpha1().Ats(namespace).Watch(context.TODO(), options)
			},
		},
		&mxycontrollerv1alpha1.At{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *atInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mxycontrollerv1alpha1.At{}, f.defaultInformer)
}
