...
import (
	...
	mxyv1alpha1 "github.com/mandyl/mxycontroller/pkg/apis/mxycontroller/v1alpha1"
	clientset "github.com/mandyl/mxycontroller/pkg/generated/clientset/versioned"
	mxyscheme "github.com/mandyl/mxycontroller/pkg/generated/clientset/versioned/scheme"
	informers "github.com/mandyl/mxycontroller/pkg/generated/informers/externalversions/mxycontroller/v1alpha1"
	listers "github.com/mandyl/mxycontroller/pkg/generated/listers/mxycontroller/v1alpha1"
...
func NewController(
	...
	utilruntime.Must(mxyscheme.AddToScheme(scheme.Scheme))
...
func (c *Controller) Run(threadiness int, stopCh <-chan struct{}) error {
	...
	klog.Info("Starting mxy client-go controller")
...
func (c *Controller) syncHandler(key string) (time.Duration, error) {
	...
	if instance.Status.Phase == "" {
		instance.Status.Phase = mxyv1alpha1.PhasePending
	}

	// Now let's make the main case distinction: implementing
	// the state diagram PENDING -> RUNNING -> DONE
	switch instance.Status.Phase {
	case mxyv1alpha1.PhasePending:
		...
		instance.Status.Phase = mxyv1alpha1.PhaseRunning
	case mxyv1alpha1.PhaseRunning:
		klog.Infof("instance %s: Phase: RUNNING", key)

		pod := newPodForCR(instance)

		// Set At instance as the owner and controller
		owner := metav1.NewControllerRef(instance, mxyv1alpha1.SchemeGroupVersion.WithKind("At"))
	...
	if !reflect.DeepEqual(original, instance) {
		...
		//_, err = c.mxyClientset.MxyV1alpha1().Ats(instance.Namespace).UpdateStatus(instance)

		//_, err = c.mxyClientset.MxycontrollerV1alpha1().Ats(instance.Namespace).UpdateStatus(ctx, instance, metav1.UpdateOptions{})
		if err != nil {
			return time.Duration(0), err
		}
	}
...
func newPodForCR(cr *mxyv1alpha1.At) *corev1.Pod {
